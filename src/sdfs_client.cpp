...
// int sdfs_client_impl::put(string local_filename, string sdfs_filename) {
...
//     string hostname;
//     hostname = put_master(master_client.get(), local_filename, sdfs_filename);
...
//     int ret = put_internal(internal_client.get(), local_filename, sdfs_filename);
...
//         if (get(temp, sdfs_filename_prefix + "." + std::to_string(num_shards)) != 0) {
//             break;
//         }
//         num_shards++;
//     }
...
// int sdfs_client_impl::get(string local_filename, string sdfs_filename) {
//     unique_ptr<tcp_client> master_client;
//     if ((master_client = sdfs_client_impl::get_master_socket()).get() == nullptr) return SDFS_FAILURE;

//     // master node correspondence to get the internal hostname
//     string hostname;
//     hostname = get_master(master_client.get(), local_filename, sdfs_filename);
...
//     // internal node correspondence to put the file
//     int ret = get_internal(internal_client.get(), local_filename, sdfs_filename);
...
// string sdfs_client_impl::get_metadata(string sdfs_filename) {
//     unique_ptr<tcp_client> master_client;
//     if ((master_client = sdfs_client_impl::get_master_socket()).get() == nullptr) return "";

//     // master node correspondence to get the internal hostname
//     string hostname;
//     hostname = get_metadata_master(master_client.get(), sdfs_filename);
...
//     string ret = get_metadata_internal(internal_client.get(), sdfs_filename);
...
// int sdfs_client_impl::del(string sdfs_filename) {
//     unique_ptr<tcp_client> master_client;
//     if ((master_client = sdfs_client_impl::get_master_socket()).get() == nullptr) return SDFS_FAILURE;

//     // master node correspondence del files
//     int status = del_master(master_client.get(), sdfs_filename);

//     return status;
// }

// int sdfs_client_impl::ls(string sdfs_filename) {
//     unique_ptr<tcp_client> master_client;
//     if ((master_client = sdfs_client_impl::get_master_socket()).get() == nullptr) return SDFS_FAILURE;

//     // master node correspondence del files
//     // @TODO: either print in the master function or relay string results here and print
//     int status = ls_master(master_client.get(), sdfs_filename);

//     return status;
// }

// int sdfs_client_impl::append(string local_filename, string sdfs_filename) {
//     unique_ptr<tcp_client> master_client;
//     if ((master_client = sdfs_client_impl::get_master_socket()).get() == nullptr) return SDFS_FAILURE;

//     // master node correspondence to get the internal hostname
//     string metadata = "test md";   // @TODO: get the metadata
//     std::vector<string> res = append_master(master_client.get(), metadata, local_filename, sdfs_filename);
//     string hostname = "";
//     string filename = "";
//     if (res.size() == 2) {
//         hostname = res[0];
...
//     // internal node correspondence to put the file
//     int ret = put_internal(internal_client.get(), local_filename, filename);
...
// int sdfs_client_impl::get_index(string sdfs_filename) {
//     unique_ptr<tcp_client> master_client;
//     if ((master_client = sdfs_client_impl::get_master_socket()).get() == nullptr) return SDFS_FAILURE;

//     // master node correspondence to get the internal hostname
//     string index = get_index_master(master_client.get(), sdfs_filename);
...
// string sdfs_client_impl::put_master(tcp_client *client, string local_filename, string sdfs_filename) {
...
// string sdfs_client_impl::get_master(tcp_client *client, string local_filename, string sdfs_filename) {
//     // SOCKET IS WITH MASTER
...
// string sdfs_client_impl::get_metadata_master(tcp_client *client, string sdfs_filename) {
//     // SOCKET IS WITH MASTER
...
// std::vector<string> sdfs_client_impl::append_master(tcp_client *client, string metadata, string local_filename, string sdfs_filename) {
//     // SOCKET IS WITH MASTER
...
// int sdfs_client_impl::del_master(tcp_client *client, string sdfs_filename) {
//     // SOCKET IS WITH MASTER
...
// int sdfs_client_impl::ls_master(tcp_client *client, string sdfs_filename) {
//     // SOCKET IS WITH MASTER
...
// string sdfs_client_impl::get_index_master(tcp_client *client, string sdfs_filename) {
//     // SOCKET IS WITH MASTER
...
// int sdfs_client_impl::put_internal(tcp_client *client, string local_filename, string sdfs_filename) {
...
// int sdfs_client_impl::get_internal(tcp_client *client, string local_filename, string sdfs_filename) {
//     // MASTER CORRESPONDENCE IS DONE
...
// string sdfs_client_impl::get_metadata_internal(tcp_client *client, string sdfs_filename) {
//     // MASTER CORRESPONDENCE IS DONE
